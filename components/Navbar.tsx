...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        {/* Cart Count Badge */}
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-100 dark:bg-purple-950/60 text-purple-700 dark:text-purple-300 font-semibold text-sm border border-purple-200 dark:border-purple-800">
          <span>🛒</span>
          <span>{count}</span>
        </div>
